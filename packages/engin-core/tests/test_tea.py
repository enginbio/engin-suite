...
def test_cost_recommendation_never_repeats_a_design_already_run():
    """#224 part 1, the D13 recommender's half of it.
    ...
    **The training set is drawn from the recommender's own candidate pool, and the
    ...
    the source and re-running. If this test ever stops failing against the unfixed
    code, it has stopped testing anything.
    """
    pool, seed = 400, 2
