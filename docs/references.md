...
- **`2026-benchling-allotropy`** (accessed 2026-08-14) — The claim is about which instrument families this library parses, and the parser directory is the reference for that. Counted from the GitHub API on the accessed date: ~60 parser packages, none for a bioreactor or fermentor.
