...
| `DECISIONS.md` | The downstream-processing share of production cost is strongly product-class dependent: reported as 45-92% for biopharmaceuticals against 20-40% for bulk fermentation products. | `2011-straathof-downstream-costs` | partially supports |
